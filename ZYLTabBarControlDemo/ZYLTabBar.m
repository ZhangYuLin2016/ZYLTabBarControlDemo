...
- (void)layoutSubviews {
    ...
    [self.items enumerateObjectsUsingBlock:^(ZYLTabBarItem * _Nonnull item, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)setItems:(NSArray<ZYLTabBarItem *> *)items {
    [items enumerateObjectsUsingBlock:^(ZYLTabBarItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)tabBarItemWasSelected:(ZYLTabBarItem *)sender {
    __block NSInteger index = 0;
    [self.items enumerateObjectsUsingBlock:^(ZYLTabBarItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        if (obj == sender) {
            obj.selected = YES;
            index = idx;
        }else {
